...
const FileUploadInput: React.FC<Props> = ({ selectedFiles, onFilesChange }) => {
  ...
  return (
    <div>
      <label htmlFor="files" className="block text-sm font-medium text-gray-300 mb-3">
        Upload Files
      </label>

      <div className="mt-2">
        <div className="flex justify-center px-6 pt-5 pb-6 border-2 border-gray-600 border-dashed rounded-lg hover:border-blue-400 transition-colors duration-200">
